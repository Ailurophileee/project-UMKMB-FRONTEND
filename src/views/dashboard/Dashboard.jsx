...
const Dashboard = () => {
  ...
  return (
    <>
      {/* ========================================================================= */}
      {/* 🧠 SMART ADVISORY AI CARD: Diletakkan paling atas sebagai Welcome Banner */}
      {/* ========================================================================= */}
      {loadingAdvisory && (
        <CCard className="mb-4 shadow-sm border-0">
          <CCardBody className="text-center py-4">
            <CSpinner color="success" />
            <p className="small text-muted mb-0 mt-2">Kecerdasan Buatan sedang merangkum strategi warungmu hari ini...</p>
          </CCardBody>
        </CCard>
      )}
